...
object SFCrimeClassifierDecisionTree {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val decisionTreeModel = new DecisionTreeClassifier().setLabelCol(colLabel + "Indexed").setFeaturesCol(colFeatures).setMaxDepth(10).
      setMaxBins(2089)
    ...
    print("Decision Tree Classifier Model training initiated..." + "\n")
    ...
    print("Decision Tree classifier classifying test data" + "\n")
    ...
    predictions.coalesce(3).write.format("csv").option("header", "true").save(dtOutputFile)
  }
